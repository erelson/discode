...
export function getCodexHookSourcePath(): string {
  const candidates = [
    join(import.meta.dirname, '../../codex', 'hook', CODEX_HOOK_FILENAME),     // source layout: src/agents/codex/ → src/codex/hook
    join(import.meta.dirname, 'hook', CODEX_HOOK_FILENAME),             // original layout: src/codex/
